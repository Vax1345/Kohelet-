...
export function ChapterCard({ chapter, onEdit }: ChapterCardProps) {
  ...
  return (
    <div className="parchment-card mb-12 max-w-2xl mx-auto relative overflow-hidden">
      ...
      <header className="mb-6 border-b border-accent/10 pb-4 relative">
        <div className="flex justify-between items-start mb-1">
          <h2 className="text-3xl font-bold text-accent">{chapter.title}</h2>
          {isAuthor && onEdit && (
            <button 
      ...
      <div className="kohelet-text mb-8 text-ink/90">
        {chapter.content}
      </div>
